...
void steerToWaypoint() {
  ...
  double waypointYaw = tf2::impl::getYaw(waypointQuat);  
  double odomYaw = tf2::impl::getYaw(odomQuat);  

  //double dTheta = waypointQuat.angleShortestPath(odomQuat);
  double dTheta = waypointYaw - odomYaw;
